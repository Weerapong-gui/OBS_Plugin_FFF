...
- **ลากกระดานได้อิสระ** ในกรอบ 16:9 มี snap เข้าเส้นกึ่งกลางและเส้นสามส่วน
- มุมขวาบอก **ระยะซ้าย/ขวา** เป็นพิกเซล ขึ้น ✓ เมื่อสมมาตร
- ลูกศรขยับทีละ 1px, Shift+ลูกศรทีละ 10px, มีปุ่มกึ่งกลางแนวนอน/แนวตั้ง/รีเซ็ต และแถบปรับขนาด 50–200%
- ปล่อยเมาส์แล้วบันทึกเอง จอสตรีมขยับตามทันที
...
4. เพิ่ม **Browser Source** ชี้ `http://127.0.0.1:9779/overlay`
   - **ขนาดต้องเป็น 1920×1080 และ transform ต้องรีเซ็ต** — หน้า overlay เป็น canvas เต็มจอ ตำแหน่งกระดานจัดจากหน้ามอนิเตอร์ ไม่ใช่จากการลากกล่องใน OBS
...
6. เปิด `http://127.0.0.1:9779/monitor` ไว้อีกหน้าต่าง แล้วลากกระดานไปตำแหน่งที่ต้องการ
